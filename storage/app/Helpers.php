...
function searchLabs($input) {
    ...
    /*
      $specific = '';
      $specific = handleSearchVariables($input, 'target', $first, $specific);
      $specific .= handleSearchVariables($input, 'subject', $first, $specific);
      $specific .= handleSearchVariables($input, 'difficulty', $first, $specific);
      $specific .= handleSearchVariables($input, 'interaction', $first, $specific);

     */
    //$query = "select * from labs where " . $general . $specific;
