...
<div id = "snapshot">
    ...
    <img src = "http://rexlab.ufsc.br:8073/motion/snapshot.jpg" width = "320" height = "240"> <!-- Snapshot for remote lab (External IP) -->
</div>
...
<!-- Begin Results -->
    <table border="1" style="position:relative; width: 100%; top:70%;"> 
        <tr>
            <td>A1</td>
            <td>A2</td>
            <td>A3</td>
...
<p style = "color: red; position: fixed; bottom: 14%;">*Verifique as chaves ativas e os sensores.</p > <!-- Alert (Optional) --> 
<?php
