...
<div class="row" style="margin:0; padding:0;">
            ...
            <ul id='goup' class='nav collapse in'>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="{{url('/labs/create/instance')}}">{{trans('labs.createInstance')}}</a></li>
                        @endif
                ...
                <li class="submenu">
                    <a href="#">
                        <i class="fa fa-file-text-o"></i> {{trans('docs.title_page')}}
                        <span class="caret pull-right"></span>
                    </a>
                    <!-- Sub menu -->
                    <ul>
                        <li><a href="{{url('/docs/create')}}">{{trans('docs.create')}}</a></li>
                        <li><a href="{{url('/docs/all')}}">{{trans('docs.all')}}</a></li>
    ...
    <div class="col-md-9 content-box-large">
        <h4 style='padding:0 0 10px; margin:0;'>@yield('title_inside')</h4>
        @yield('inside')
    </div>
</div>
@stop
