...
<div class="container" style="margin-top:35px;">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            ...
            <img src="{{asset('img/crie.jpg')}}" width="100%">
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div id='courses'>
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading" style="padding:0 15px 0 15px">
                            ...
                            <a href="http://gt-mre.ufsc.br/course/index.php" target="_blank" style="padding-left:15px; font-size: 12pt">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <a href="http://gt-mre.ufsc.br/course/view.php?id={{$course['id']}}" target="_blank">
