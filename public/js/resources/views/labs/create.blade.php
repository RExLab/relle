                    ...
                    <div class="tab-pane fade" id="tab2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a class="btn btn-primary pull-left btnPrevious">{{trans('interface.previous')}}</a>
                                <a class="btn btn-primary pull-right btnNext">{{trans('interface.next')}}</a>
                            </div>
                        </div>
                    </div>
                    <!--
                        ...
                        <div class="controls"> 
                            <div class="entry input-group col-lg-5">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-success btn-add" type="button" style="margin-top:0">
